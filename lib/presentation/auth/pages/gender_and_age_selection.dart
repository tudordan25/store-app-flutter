...
import 'package:store_app/common/helper/bottomsheet/app_bottomsheet.dart';
...
import 'package:store_app/presentation/auth/bloc/age_selection_cubit.dart';
import 'package:store_app/presentation/auth/bloc/ages_display_cubit.dart';
import 'package:store_app/presentation/auth/bloc/gender_selection_cubit.dart';
import 'package:store_app/presentation/auth/widgets/ages.dart';
    ...
    return BlocBuilder<AgeSelectionCubit, String>(builder: (context, state) {
      return GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(color: AppColors.secondBackground, borderRadius: BorderRadius.circular(30)),
          child: Row(
            mainAxisAlignment: MainAxisAlignment.spaceBetween,
            children: [
