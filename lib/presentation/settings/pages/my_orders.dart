...
import 'package:store_app/presentation/settings/bloc/orders_display_cubit.dart';
import 'package:store_app/presentation/settings/pages/order_detail.dart';
    ...
    return ListView.separated(
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
            onTap: () {
              AppNavigator.push(context, OrderDetailPage(orderEntity: orders[index]));
            },
            child: Container(
              height: 70,
